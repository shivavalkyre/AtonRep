...
anywheresoftware.b4a.objects.drawable.BitmapDrawable _bd = null;
 //BA.debugLineNum = 57;BA.debugLine="Sub BmpToDrawable(bmp As Bitmap)As BitmapDrawable";
 //BA.debugLineNum = 58;BA.debugLine="Dim bd As BitmapDrawable";
_bd = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 59;BA.debugLine="bd.Initialize(bmp)";
_bd.Initialize((android.graphics.Bitmap)(_bmp.getObject()));
 //BA.debugLineNum = 60;BA.debugLine="Return bd";
if (true) return _bd;
...
anywheresoftware.b4a.keywords.Regex.MatcherWrapper _matcher1 = null;
 //BA.debugLineNum = 73;BA.debugLine="Sub CountMatches(text As String,pattern As String)";
 //BA.debugLineNum = 74;BA.debugLine="Dim tmp_count As Int = 0";
_tmp_count = (int) (0);
 //BA.debugLineNum = 75;BA.debugLine="Dim Matcher1 As Matcher";
_matcher1 = new anywheresoftware.b4a.keywords.Regex.MatcherWrapper();
 //BA.debugLineNum = 76;BA.debugLine="Matcher1 = Regex.Matcher(pattern, text)";
_matcher1 = anywheresoftware.b4a.keywords.Common.Regex.Matcher(_pattern,_text);
 //BA.debugLineNum = 77;BA.debugLine="Do While Matcher1.Find";
while (_matcher1.Find()) {
 //BA.debugLineNum = 78;BA.debugLine="tmp_count = tmp_count +1";
_tmp_count = (int) (_tmp_count+1);
 }
;
 //BA.debugLineNum = 80;BA.debugLine="Return tmp_count";
...
anywheresoftware.b4j.object.JavaObject _etxt = null;
 //BA.debugLineNum = 29;BA.debugLine="Sub EditTextEmail(EditTxt As EditText)";
 //BA.debugLineNum = 31;BA.debugLine="Dim ETxt As JavaObject = EditTxt";
...
_etxt = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_edittxt.getObject()));
 //BA.debugLineNum = 32;BA.debugLine="ETxt.RunMethod(\"setCompoundDrawablesWithIntrinsic";
...
anywheresoftware.b4j.object.JavaObject _etxt = null;
 //BA.debugLineNum = 35;BA.debugLine="Sub EditTextPassword(EditTxt As EditText)";
 //BA.debugLineNum = 37;BA.debugLine="Dim ETxt As JavaObject = EditTxt";
_etxt = new anywheresoftware.b4j.object.JavaObject();
_etxt = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_edittxt.getObject()));
 //BA.debugLineNum = 38;BA.debugLine="ETxt.RunMethod(\"setCompoundDrawablesWithIntrinsic";
...
anywheresoftware.b4j.object.JavaObject _etxt = null;
 //BA.debugLineNum = 41;BA.debugLine="Sub EditTextPassword1(EditTxt As EditText)";
 //BA.debugLineNum = 43;BA.debugLine="Dim ETxt As JavaObject = EditTxt";
_etxt = new anywheresoftware.b4j.object.JavaObject();
_etxt = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_edittxt.getObject()));
 //BA.debugLineNum = 44;BA.debugLine="ETxt.RunMethod(\"setCompoundDrawablesWithIntrinsic";
...
anywheresoftware.b4j.object.JavaObject _etxt = null;
 //BA.debugLineNum = 23;BA.debugLine="Sub EditTextUsername(EditTxt As EditText)";
 //BA.debugLineNum = 25;BA.debugLine="Dim ETxt As JavaObject = EditTxt";
_etxt = new anywheresoftware.b4j.object.JavaObject();
_etxt = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_edittxt.getObject()));
 //BA.debugLineNum = 26;BA.debugLine="ETxt.RunMethod(\"setCompoundDrawablesWithIntrinsic";
...
double _h = 0;
 //BA.debugLineNum = 47;BA.debugLine="Sub TextToBitmap (s As String, FontSize As Float)";
 //BA.debugLineNum = 48;BA.debugLine="Dim Bmp As Bitmap";
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 49;BA.debugLine="Bmp.InitializeMutable(28dip, 28dip)";
_bmp.InitializeMutable(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (28)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (28)));
 //BA.debugLineNum = 50;BA.debugLine="Dim cvs As Canvas";
_cvs = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 51;BA.debugLine="cvs.Initialize2(Bmp)";
_cvs.Initialize2((android.graphics.Bitmap)(_bmp.getObject()));
 //BA.debugLineNum = 52;BA.debugLine="Dim h As Double = cvs.MeasureStringHeight(s, Type";
_h = _cvs.MeasureStringHeight(_s,anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME(),_fontsize);
 //BA.debugLineNum = 53;BA.debugLine="cvs.DrawText(s, Bmp.Width / 2, Bmp.Height / 2 + h";
_cvs.DrawText(_ba,_s,(float) (_bmp.getWidth()/(double)2),(float) (_bmp.getHeight()/(double)2+_h/(double)2),anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME(),_fontsize,anywheresoftware.b4a.keywords.Common.Colors.Gray,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 //BA.debugLineNum = 54;BA.debugLine="Return Bmp";
if (true) return _bmp;
...
public static boolean  _validatepassword(anywheresoftware.b4a.BA _ba,String _pwd,int _minlength,int _numupper,int _numlower,int _numnumbers,int _numspecial) throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Private Sub ValidatePassword(pwd As String,minLeng";
 //BA.debugLineNum = 64;BA.debugLine="If pwd.Length < minLength Then Return False";
if (_pwd.length()<_minlength) { 
if (true) return anywheresoftware.b4a.keywords.Common.False;};
 //BA.debugLineNum = 65;BA.debugLine="If CountMatches(pwd,\"[A-Z]\") < numUpper Then Retu";
if (_countmatches(_ba,_pwd,"[A-Z]")<_numupper) { 
if (true) return anywheresoftware.b4a.keywords.Common.False;};
 //BA.debugLineNum = 66;BA.debugLine="If CountMatches(pwd,\"[a-z]\") < numLower Then Retu";
if (_countmatches(_ba,_pwd,"[a-z]")<_numlower) { 
if (true) return anywheresoftware.b4a.keywords.Common.False;};
 //BA.debugLineNum = 67;BA.debugLine="If CountMatches(pwd,\"[0-9]\") < numNumbers Then Re";
if (_countmatches(_ba,_pwd,"[0-9]")<_numnumbers) { 
if (true) return anywheresoftware.b4a.keywords.Common.False;};
 //BA.debugLineNum = 68;BA.debugLine="If CountMatches(pwd,\"[^a-zA-Z0-9]\") < numSpecial";
