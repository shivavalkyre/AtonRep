...
public class httputils2service extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.atonrep", "com.atonrep.httputils2service");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.atonrep.httputils2service", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
_job = (com.atonrep.httpjob)(_taskidtojob.Get((Object)(_taskid)));
...
anywheresoftware.b4a.keywords.Common.LogImpl("310878982","HttpUtils2Service: job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("310813445","HttpUtils2Service (hc_ResponseError): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("310682371","HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("310420231",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 //BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
anywheresoftware.b4a.keywords.Common.LogImpl("310420232","Switching to File.DirInternal",0);
...
public static String  _submitjob(com.atonrep.httpjob _job) throws Exception{
int _taskid = 0;
