...
public class register extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.atonrep", "com.atonrep.register");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.atonrep", "com.atonrep.register");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.atonrep.register", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 26;BA.debugLine="Activity.LoadLayout(\"Register\")";
mostCurrent._activity.LoadLayout("Register",mostCurrent.activityBA);
 //BA.debugLineNum = 27;BA.debugLine="general.SetBackgroundTintList(txtUsername, Colors";
mostCurrent._general._setbackgroundtintlist /*String*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._txtusername.getObject())),anywheresoftware.b4a.keywords.Common.Colors.White,anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 28;BA.debugLine="general.SetBackgroundTintList(txtEmail, Colors.Wh";
...
mostCurrent._general._edittextusername /*String*/ (mostCurrent.activityBA,mostCurrent._txtusername);
 //BA.debugLineNum = 31;BA.debugLine="general.EditTextEmail(txtEmail)";
mostCurrent._general._edittextemail /*String*/ (mostCurrent.activityBA,mostCurrent._txtemail);
 //BA.debugLineNum = 32;BA.debugLine="general.EditTextPassword(txtPassword)";
...
public static String  _button2_click() throws Exception{
 ...
 //BA.debugLineNum = 45;BA.debugLine="StartActivity(Login)";
...
mostCurrent._txtpassword = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private ClickStatus As Int = 0";
_clickstatus = (int) (0);
...
public static String  _txtpassword_click() throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Private Sub txtPassword_Click";
 //BA.debugLineNum = 51;BA.debugLine="If ClickStatus=0 Then";
if (_clickstatus==0) { 
 //BA.debugLineNum = 52;BA.debugLine="general.EditTextPassword1(txtPassword)";
mostCurrent._general._edittextpassword1 /*String*/ (mostCurrent.activityBA,mostCurrent._txtpassword);
 //BA.debugLineNum = 53;BA.debugLine="ClickStatus=1";
_clickstatus = (int) (1);
 //BA.debugLineNum = 55;BA.debugLine="txtPassword.PasswordMode=False";
mostCurrent._txtpassword.setPasswordMode(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 57;BA.debugLine="general.EditTextPassword(txtPassword)";
mostCurrent._general._edittextpassword /*String*/ (mostCurrent.activityBA,mostCurrent._txtpassword);
 //BA.debugLineNum = 58;BA.debugLine="ClickStatus=0";
_clickstatus = (int) (0);
 //BA.debugLineNum = 59;BA.debugLine="txtPassword.PasswordMode=True";
