...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.atonrep.b4xtimedtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.atonrep.b4xtimedtemplate.class).invoke(this, new Object[] {null});
        else
...
public com.atonrep.anotherprogressbar _anotherprogressbar1 = null;
...
_anotherprogressbar1 = new com.atonrep.anotherprogressbar();
...
public ResumableSub_Show(com.atonrep.b4xtimedtemplate parent,com.atonrep.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.atonrep.b4xtimedtemplate parent;
